...
public class UltrasoundArm {
	...
	public int getAgeLeft() {
		return (int) (System.currentTimeMillis() - times[Directions.LEFT.ordinal()]);
	}

	public int getAgeRight() {
		return (int) (System.currentTimeMillis() - times[Directions.RIGHT.ordinal()]);
	}

	public int getAgeCenter() {
		return (int) (System.currentTimeMillis() - times[Directions.CENTER.ordinal()]);
	}
